...
import ResultadosEvaluacion from '/src/vistas/ResultadosEvaluacion/ResultadosEvaluacion.jsx';
    ...
    <ThemeProvider>
        <HashRouter>
            <Routes >
                ...
                <Route path="/ConfigurarEvaluacion" element={<ConfigurarEvaluacion />} />
                <Route path="/RendirEvaluacion" element={<RendirEvaluacion />} />
                <Route path="/Documentacion" element={<Documentacion />} />
                <Route path="/Agradecimientos" element={<Agradecimientos />} />
                <Route path="/ResultadosEvaluacion" element={<ResultadosEvaluacion />} />
            </Routes>
        </HashRouter>
    </ThemeProvider>
    </>
